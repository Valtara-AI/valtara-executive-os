...
VEX-OS-PCT-001 · Version 1.0 · August 2026

| Document ID | VEX-OS-PCT-001 |
| --- | --- |
| Version | 1.0 |
...
This Product Changelog records all version releases for Valtara Executive OS (VEX-OS) from Sprint 1 onward. It follows Keep a Changelog (keepachangelog.com) conventions adapted for an AI product with governance obligations.
...
VEX-OS uses Semantic Versioning (semver.org): MAJOR.MINOR.PATCH
...
*First beta release for pilot executives. Core onboarding, dashboard, and Gmail/Google Calendar integration available.*
...
*Project scaffold, authentication, and repository structure established. No user-facing features.*
...
*VEX-OS-PCT-001 · Version 1.0 · August 2026 · Confidential — Internal Use Only*
