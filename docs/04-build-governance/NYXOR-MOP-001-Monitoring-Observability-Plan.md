...
NYXOR-MOP-001 · Version 1.0 · August 2026

| Document ID    | NYXOR-MOP-001                                 |
| -------------- | --------------------------------------------- |
| Version        | 1.0                                           |
| Status         | Active                                        |
...
| Date           | August 2026                                   |
| Depends On     | NYXOR-SAD-001, NYXOR-DST-001                  |
| Classification | Confidential — Internal Use Only              |

# 1. Purpose & Scope

This Monitoring & Observability Plan defines the logging strategy, metrics collection, alerting thresholds, AI output monitoring, cost tracking, and incident response playbook for Nyxor. Observability is built in from Sprint 1 — not added post-launch.

The three pillars of NYXOR observability are: (1) structured logs for event-level detail; (2) metrics for system health trends; (3) traces for request-level performance. All three are required before production launch.
...
| Audit log              | Dedicated append-only PostgreSQL table — see NYXOR-SEC-001                                                          |
...
| Metric                             | Source                             |
| ---------------------------------- | ---------------------------------- |
| HITL approval rate (7-day rolling) | NYXOR application database         |
...
_NYXOR-MOP-001 · Version 1.0 · August 2026 · Confidential — Internal Use Only_
