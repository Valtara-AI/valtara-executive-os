...
VEX-OS-PBT-001 · Version 1.0 · August 2026

| Document ID | VEX-OS-PBT-001 |
| --- | --- |
| Version | 1.0 |
| Status | Active |
...
VEX-OS uses two-week sprints. Sprint 1 begins only after all 23 pre-build documents are completed and CLAUDE.md is initialized.
...
| Feature branches | feature/[ticket-id]-[short-description] — e.g. feature/VEX-001-onboarding-agent |
...
New developer environment setup (also see VEX-OS-DOG-001 Developer Onboarding Guide):
...
*VEX-OS-PBT-001 · Version 1.0 · August 2026 · Confidential — Internal Use Only*
