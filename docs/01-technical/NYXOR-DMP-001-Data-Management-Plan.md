...
NYXOR-DMP-001 · Version 1.0 · August 2026

| Document ID    | NYXOR-DMP-001                                      |
| -------------- | -------------------------------------------------- |
| Version        | 1.0                                                |
...
| Referenced By  | NYXOR-SEC-001, NYXOR-PCF-001                       |
| Classification | Confidential — Internal Use Only                   |

# 1. Purpose & Scope

This Data Management Plan (DMP) defines how data is collected, classified, stored, protected, retained, and disposed of within Nyxor. It establishes the governance framework for all data assets throughout their lifecycle, ensuring compliance with applicable privacy regulations and alignment with NYXOR's security architecture.

This plan applies to all data processed or stored by NYXOR, including executive profile data, integration data sourced from third-party platforms, AI-generated outputs, audit records, and operational telemetry.
...
- Email and calendar data is retrieved contextually (for active agent tasks) rather than bulk-synced to NYXOR storage.
...
| Key management         | Encryption keys stored exclusively in .env files; never in code or database; key rotation procedure in NYXOR-SEC-001 |
...
NYXOR maintains traceable data lineage for all AI-generated content to support explainability and compliance requirements.
...
NYXOR supports the exercise of data subject rights as required by PIPEDA, GDPR, and CCPA. All rights requests are actioned within 30 days of verified receipt.
...
| Google (OAuth)                                  | OAuth authorization flow metadata; Gmail/Calendar data per connected scopes                                                    |
| Microsoft (OAuth)                               | OAuth authorization flow metadata; Outlook Mail/Calendar/Teams data per connected scopes                                       |
| Slack (OAuth)                                   | OAuth authorization flow metadata; channel/message data per connected scopes                                                   |
| PandaDoc (OAuth)                                | OAuth authorization flow metadata; document content and recipient data for documents created through NYXOR                     |
| Stripe                                          | Subscription/billing status; payment details go directly to Stripe, never through Valtara's own systems                        |
| Resend                                          | Executive email address and notification content, for transactional email only (HITL review requests, task-completion notices) |

NYXOR does not sell, rent, or broker executive data to any third party for commercial purposes. No advertising platforms receive any data.
...
_NYXOR-DMP-001 · Version 1.0 · August 2026 · Confidential — Internal Use Only_
