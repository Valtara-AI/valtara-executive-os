...
| PandaDoc (OAuth)                                | OAuth authorization flow metadata; document content and recipient data for documents created through VEX-OS                    |
...
_VEX-OS-DMP-001 · Version 1.0 · August 2026 · Confidential — Internal Use Only_
