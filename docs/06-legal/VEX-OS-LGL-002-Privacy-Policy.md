...
VEX-OS-LGL-002 · Version 1.0 (Draft) · August 2026

| Document ID    | VEX-OS-LGL-002                                                                                                                                                                                                                               |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Version        | 1.0 — **Draft, not yet published**                                                                                                                                                                                                           |
| Status         | **Requires qualified legal counsel review before publication.** Content is derived from VEX-OS's actual data architecture (VEX-OS-DMP-001, VEX-OS-PCF-001) for factual accuracy, not drafted independently of what the system actually does. |
| Owner          | Francis Ogbogu — Chief AI Officer, Valtara AI (Privacy Officer)                                                                                                                                                                              |
| Depends On     | VEX-OS-DMP-001 (Data Management Plan), VEX-OS-PCF-001 (Privacy & Compliance Framework)                                                                                                                                                       |
...
Valtara Inc., operating as Valtara AI ("**Valtara**," "**we**"), based in Saskatoon, Saskatchewan, Canada, is the data controller for personal information processed through Valtara Executive OS ("**VEX-OS**"). Our Privacy Officer is Francis Ogbogu, Chief AI Officer, reachable at fcogbogu@gmail.com.
...
| PandaDoc (if connected)          | Document status, recipients, and content for documents you create through VEX-OS                                     | Board/investor document creation and send workflows                                                                              |
...
We share data only with the service providers ("sub-processors") who help us operate VEX-OS, each bound by a data processing agreement:
...
| Google / Microsoft / Slack / PandaDoc            | OAuth authorization metadata, and whatever data you've authorized VEX-OS to access on that platform | The integrations you've chosen to connect                       |
...
- Access to your data within VEX-OS is role-based and audit-logged; the audit log itself is tamper-evident (cryptographically chained) and cannot be altered, even by system administrators.
...
_VEX-OS-LGL-002 · Version 1.0 (Draft) · August 2026 · Not yet approved for publication_
